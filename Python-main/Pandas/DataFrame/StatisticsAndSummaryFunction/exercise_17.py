# What method would you use to find the employee with the highest salary, and display their Name and Department?
import pandas as pd
import numpy as np
...
maxSal= df['Salary'].idxmax()

print(df.loc[maxSal,['Name','Department']])

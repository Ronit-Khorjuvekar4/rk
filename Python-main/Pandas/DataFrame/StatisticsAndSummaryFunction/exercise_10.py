# What command would you use to find the mean ExperienceYears for employees in the IT department?
import pandas as pd
import numpy as np
...
meanExp = df.loc[df['Department']== 'IT'] 

print(meanExp['ExperienceYears'].mean())

print(df.loc[df['Department'] == 'IT','ExperienceYears'].mean())

# What command would you use to find the employee with the minimum Age and display their Name and JoiningYear?
import pandas as pd
import numpy as np
...
minAge = df['Age'].idxmin()

print(df.loc[minAge,['Name','JoiningYear']])

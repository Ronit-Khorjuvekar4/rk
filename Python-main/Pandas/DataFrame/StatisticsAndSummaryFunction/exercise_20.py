# How do you calculate the weighted average of Salary, using ExperienceYears as the weights?
import pandas as pd
import numpy as np
...
weighted_average_salary = (df['Salary'] * df['ExperienceYears']).sum() / df['ExperienceYears'].sum()
print(weighted_average_salary)

# What method would you use to group the data by Department and calculate the average Salary and Age for each group?
import pandas as pd
import numpy as np
...
ok = df.groupby('Department')[['Salary','Age']].mean()

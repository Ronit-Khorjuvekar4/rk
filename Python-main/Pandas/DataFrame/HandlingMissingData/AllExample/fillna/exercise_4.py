#What command would you use to fill missing values in the ExperienceYears column with the median of the column?
import pandas as pd
import numpy as np
...
df['ExperienceYears'].fillna(value=df['ExperienceYears'].median(),inplace=True)

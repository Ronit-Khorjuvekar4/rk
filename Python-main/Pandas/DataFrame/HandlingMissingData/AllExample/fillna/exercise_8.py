# What method would you use to fill missing values in the JoiningYear column using backward fill (method='bfill')?
import pandas as pd
import numpy as np
...
df['JoiningYear'].fillna(method='bfill',inplace=True)

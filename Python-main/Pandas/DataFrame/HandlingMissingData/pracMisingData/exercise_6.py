# What method would you use to fill missing values in the Department column with the most frequent value?
import pandas as pd
import numpy as np
...
df['Department'].fillna(most_frequent_department, inplace=True)

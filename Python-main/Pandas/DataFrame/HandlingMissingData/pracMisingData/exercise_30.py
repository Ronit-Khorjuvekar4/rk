# What command would you use to fill missing values with different strategies for different columns in a single operation 
# (e.g., mean for Salary, mode for Gender, and forward fill for Education)?
import pandas as pd
import numpy as np

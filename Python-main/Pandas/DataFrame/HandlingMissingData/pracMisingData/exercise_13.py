# What command would you use to fill missing values in the ExperienceYears column with the median value?
import pandas as pd
import numpy as np
...
print(df['ExperienceYears'].fillna(df['ExperienceYears'].median(),inplace=True))

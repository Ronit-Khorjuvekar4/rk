# How can you create a boolean mask to identify rows where the Salary and ExperienceYears columns both have missing values?
import pandas as pd
import numpy as np
...
data = {
    ...
    'ExperienceYears': [5, np.nan, np.nan, 7, 1, 15, 2, 6, 10, 4],
...
ok = (df['Salary'].isnull()) & (df['ExperienceYears'].isnull())

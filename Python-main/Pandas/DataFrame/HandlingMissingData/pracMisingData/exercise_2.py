# How can you count the total number of missing values in the entire DataFrame?
import pandas as pd
import numpy as np
...
countMissingColumns = df.isnull().sum() #Shows missing values in specific columns
countMissingDf = df.isnull().sum().sum() #Shows missing values in entire DataFrame


print(countMissingColumns)
print("Missing Values in DataFrame : ",countMissingDf)

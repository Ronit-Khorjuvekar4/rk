# How would you fill missing values in the JoiningYear column with the median value, but only for rows where the Department is IT?
import pandas as pd
import numpy as np
...
median_joining_year = df[df['Department'] == 'IT']['JoiningYear'].median()
df.loc[df['Department'] == 'IT', 'JoiningYear'] = df.loc[df['Department'] == 'IT', 'JoiningYear'].fillna(median_joining_year)
print(df)

# Select the 'ID', 'Name', and 'Performance Score' of employees whose 'Performance Score' is either less than 3 or greater than 9.
# 
import pandas as pd
...
print(df.loc[(df['PerformanceScore'] < 3) | (df['PerformanceScore'] > 9),['ID','Name','PerformanceScore']])

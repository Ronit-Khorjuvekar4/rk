# Extract rows where ExperienceYears is greater than 10, but only display columns Name, City, and 
# a newly created column Seniority which assigns 'Senior' to all selected rows.
# 
import pandas as pd
import numpy as np
...
ExperienceYears = df['ExperienceYears'] > 10

df['Seniority'] = None

# df.loc[ExperienceYears]

df.loc[ExperienceYears,'Seniority'] = 'Senior'

print(df.loc[ExperienceYears,['Name','City','Seniority']])

# Use loc to fill missing values in the Department column 
# based on the City: if City is 'New York', fill with 'HR'.
#
import pandas as pd
import numpy as np
...
data = {
    ...
    'Department': [None, 'IT', 'Finance', 'IT', 'HR', 'Finance', np.nan, 'HR', 'Finance', 'IT', 'HR', 'Finance', 'IT', 'HR', np.nan, 'Finance', 'IT', 'HR', 'Finance', 'IT', 'Finance', np.nan, 'HR', 'IT', 'Finance', 'IT', np.nan, 'HR', 'Finance', 'IT'],
...
# print((df['Department'].isna()) & ( df['City'] == 'New York'),['Department'])

df.loc[(df['Department'].isna()) & ( df['City'] == 'New York'),['Department']] = 'HR'

# Select the rows where the 'ID' is between 100 and 110 (inclusive) and return only the 'Name', 'Department', and 'Salary' columns.
# 
import pandas as pd
...
print(df.loc[(df['ID'] >= 100) & (df['ID'] <= 200), ['Name', 'Department', 'Salary']])

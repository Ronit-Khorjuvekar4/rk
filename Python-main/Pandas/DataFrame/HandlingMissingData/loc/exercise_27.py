# Select rows where City is in the list ['Boston', 'Seattle', 'Austin'] and ExperienceYears is an even number.
# 
import pandas as pd
...
row = (df['City'].isin(['New York', 'Chicago', 'Houston'])) & (df['ExperienceYears'] % 2 == 0)

# Extract rows where the Name column contains at least one space (e.g., first name and last name).
# 
import pandas as pd

data = {
    'Name': ['Alice Johnson', 'Bob Smith', 'Charlie Brown', 'David Wilson', 'Eva Martinez', 
             'Fiona Davis', 'George White', 'Hannah Scott', 'IanLewis', 'Julia Clark'],
...
print(df.loc[df['Name'].str.contains(' ')])

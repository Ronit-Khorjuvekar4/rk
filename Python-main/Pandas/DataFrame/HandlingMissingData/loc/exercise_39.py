# Select employees whose 'Name' starts with the letter 'A' and 'Performance Score' is greater than 6, 
# returning the 'ID', 'Name', and 'Performance Score'.
# 
import pandas as pd
...
row = (df['Name'].str.startswith('A')) & (df['PerformanceScore'] > 6)

# Question :- Using loc, fill all missing values 
# in the Salary column with the mean Salary of 
...
data = {
    ...
    'Department': ['HR', 'IT', 'Finance', 'IT', 'HR', 'Finance', 'IT', 'HR', 'Finance', 'IT', 'HR', 'Finance', 'IT', 'HR', 'HR', 'Finance', 'IT', 'HR', 'Finance', 'IT', 'Finance', 'IT', 'HR', 'IT', 'Finance', 'IT', 'Finance', 'HR', 'Finance', 'IT'],
...
print(df.loc[df['Salary'].isna(),['Salary','Department']])
...
# df.loc[df['Salary'].isna(),['Salary']] = df.groupby('Department')['Salary'].transform('mean')

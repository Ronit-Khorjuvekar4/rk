# Extract rows where the Department is either 'Sales' or 'HR'.
# 
import pandas as pd
...
# dept = (df['Department'] == 'Sales') | (df['Department'] == 'HR')
# sales_hr = df.loc[dept,:]
# print(sales_hr)

sales_hr_loc = df.loc[df['Department'].isin(['Sales', 'HR'])]
print(sales_hr_loc)

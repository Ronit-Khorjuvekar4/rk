# Select rows where the 'Performance Score' is not between 4 and 8 (inclusive), 
# returning only the 'Name', 'Department', and 'Performance Score'.
# 
import pandas as pd
...
row = (df['PerformanceScore'] > 8) | (df['PerformanceScore'] < 4)

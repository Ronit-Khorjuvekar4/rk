# Retrieve rows where Salary is missing (NaN), and update their Salary to the mean salary of the dataset using loc.
# 
import pandas as pd
...
row = df['Salary'].isnull()

meanSal = round(df['Salary'].mean())

df.loc[row,'Salary'] = meanSal

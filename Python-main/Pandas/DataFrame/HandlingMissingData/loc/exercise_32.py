# Select the 'Name' and 'Performance Score' of employees who joined before January 1, 2020,
# and have a performance score greater than 8.
# 
import pandas as pd
...
data = {
    ...
    'PerformanceScore': [8, 9, 9, 7, 8, 10, 5, 6, 7, 4, 9, 5, 6, 8, 3]
}

df = pd.DataFrame(data)

row = (df['JoiningDate'] < '2020-01-1') & (df['PerformanceScore'] > 8)

print(df.loc[row,['Name','PerformanceScore']])
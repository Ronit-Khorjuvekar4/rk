# Select the rows for employees whose 'Department' is either 'HR' or 'Finance', and their 'Salary' 
# is less than 60,000, returning all columns.
# 
import pandas as pd
...
row = (df['Department'].isin(['HR','Finance'])) & (df['Salary'] < 60000)

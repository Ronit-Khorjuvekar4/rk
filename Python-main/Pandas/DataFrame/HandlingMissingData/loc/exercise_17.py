# Extract rows where City is 'Chicago' and either Gender is 'Female' or ExperienceYears is more than 10.
# 
import pandas as pd
...
city = (df['City'] == 'Chicago') & ((df['Gender'] == 'Female') | (df['ExperienceYears'] > 10))

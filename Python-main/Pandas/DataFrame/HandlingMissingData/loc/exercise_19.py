# Select rows for columns Name, City, and Department where Salary is greater than the average salary of the dataset.
# 
import pandas as pd
...
avgSal = df['Salary'] > df['Salary'].mean()

print(df.loc[avgSal,['Name', 'City', 'Department']])

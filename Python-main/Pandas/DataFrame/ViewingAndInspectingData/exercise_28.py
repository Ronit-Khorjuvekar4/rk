# How can you view all rows of the DataFrame where a specific column's values are greater than the mean of that column?
import pandas as pd
...
filtered_rows = df[df['ColumnName'] > mean_value]
print(filtered_rows)

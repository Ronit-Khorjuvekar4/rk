# How can you retrieve a summary of the DataFrame, 
# grouping the data by a specific column and calculating aggregate statistics for another column?
import pandas as pd
...
summary = df.groupby('Name')['JoiningYear'].agg(['mean', 'sum', 'count'])
print(summary)

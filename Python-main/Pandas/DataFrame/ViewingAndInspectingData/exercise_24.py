# How can you view the top 2 most frequent values in a specific column?
import pandas as pd
...
top_2_frequent_values = df['ColumnName'].value_counts().head(2)
print(top_2_frequent_values)

# How would you display a concise summary of the DataFrame, excluding any specific column from the output?
import pandas as pd
...
df_excluding_column = df.drop(columns=['Salary'])
summary = df_excluding_column.info()
print(summary)

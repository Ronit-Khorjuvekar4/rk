# Add a new column PeerSalaryDifference which shows 
# the difference between Salary and the mean Salary of 
...
df['PeerSalaryDifference'] = df['Salary'] - df.groupby('Department')['Salary'].transform(lambda x: x.mean())

# Create a new column IsTopPerformer which 
# is 'Yes' if Salary is above the mean Salary of the department and 'No' otherwise.
#
import pandas as pd
...
df['IsTopPerformer'] = df['Salary'].gt(mean_salary_by_dept).map({True: 'Yes', False: 'No'})

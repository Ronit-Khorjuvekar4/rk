# Create a new column IsExperienced which is 
# 'True' if YearsSinceJoining is more than 5 and 'False' otherwise.
#
import pandas as pd
import numpy as np
data = {
...
df['IsExperienced'] = np.where(df['YearsSinceJoining'] > 5,True,False)

# Insert a new column IsHighSalary with 'True' for 
# employees with Salary greater than 65000 and 'False' otherwise.
#
import pandas as pd
...
df.loc[:,'IsHighSalary'] = df['Salary'].apply(lambda x: True if x > 65000 else False)
